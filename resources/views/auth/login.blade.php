            ...
            <section class="hidden px-12 py-14 lg:flex lg:flex-col lg:justify-between">
                <div>
                    <div class="inline-flex items-center gap-4 rounded-full border border-white/10 bg-white/5 px-5 py-3 backdrop-blur">
                        <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-xl font-black text-indigo-700 shadow-lg">LE</div>
                        <div>
                            <p class="text-xs font-bold uppercase tracking-[0.35em] text-indigo-300">CRM LipoExpress</p>
                    ...
                    <div class="rounded-[2rem] border border-white/10 bg-white/95 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl sm:p-8">
                        <div class="lg:hidden">
                            <div class="inline-flex items-center gap-3 rounded-full bg-slate-100 px-4 py-2">
                                <div class="flex h-10 w-10 items-center justify-center rounded-2xl bg-indigo-700 text-lg font-black text-white">LE</div>
                                <div>
                                    <p class="text-[11px] font-bold uppercase tracking-[0.28em] text-indigo-700">LipoExpress</p>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="mt-8 space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="correo@lipoexpress.cl"
                                >
                                @error('email')
