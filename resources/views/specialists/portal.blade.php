        ...
        <div class="mx-auto max-w-[1240px] space-y-3">
            ...
            <section class="specialist-panel-inner-band">
                <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                    <article class="specialist-panel-soft-card rounded-[1rem] px-5 py-4">
                        <div class="flex items-center gap-4">
                            <div class="specialist-panel-stat-icon flex h-11 w-11 items-center justify-center rounded-full bg-violet-100 text-violet-600">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-[1.7rem] font-black leading-none text-slate-900">{{ $stats['services'] }}</p>
                                <p class="mt-1 text-xs text-slate-500">Servicios activos</p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="specialist-panel-soft-card rounded-[1rem] px-5 py-4">
                        <div class="flex items-center gap-4">
                            <div class="specialist-panel-stat-icon flex h-11 w-11 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                            </div>
                            <div>
                                ...
                                <p class="mt-1 text-[1.7rem] font-black leading-none text-slate-900">{{ $stats['today'] }}</p>
                                <p class="mt-1 text-xs text-slate-500">Reservas programadas</p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="specialist-panel-soft-card rounded-[1rem] px-5 py-4">
                        <div class="flex items-center gap-4">
                            <div class="specialist-panel-stat-icon flex h-11 w-11 items-center justify-center rounded-full bg-amber-100 text-amber-600">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-[1.7rem] font-black leading-none text-slate-900">{{ $stats['pending'] }}</p>
                                <p class="mt-1 text-xs text-slate-500">Esperando confirmacion</p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="specialist-panel-soft-card rounded-[1rem] px-5 py-4">
                        <div class="flex items-center gap-4">
                            <div class="specialist-panel-stat-icon flex h-11 w-11 items-center justify-center rounded-full bg-indigo-100 text-indigo-600">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-[1.7rem] font-black leading-none text-slate-900">{{ $stats['week'] }}</p>
                                <p class="mt-1 text-xs text-slate-500">Total programadas</p>
                            </div>
                        </div>
                    </article>
                </div>
            ...
            <section class="specialist-panel-grid-two grid gap-3 xl:grid-cols-2">
                <article class="specialist-panel-card specialist-panel-next-card rounded-[1rem] border-l-[3px] border-l-emerald-500 px-5 py-4">
                    <p class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">Siguiente cita</p>
                    @if($nextBooking)
                        <div class="specialist-panel-next-body mt-3 grid grid-cols-2 items-center gap-4">
                            <div class="flex items-center gap-4">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100 text-base font-black text-emerald-700">
                                    {{ strtoupper(substr($nextBooking->client->name ?? 'C', 0, 2)) }}
                                </div>
                                <div class="min-w-0">
                                    <h2 class="truncate text-xl font-black tracking-tight text-slate-900">{{ $nextBooking->client->name ?? 'Cliente sin nombre' }}</h2>
                                    <p class="mt-1 text-sm font-semibold text-slate-600">{{ $nextBooking->service->name ?? 'Servicio sin nombre' }}</p>
                            ...
                            <div class="specialist-panel-next-time h-full border-l border-slate-200 pl-5 text-center">
                                <span class="inline-flex rounded-full bg-emerald-100 px-4 py-1 text-[10px] font-black uppercase tracking-[0.24em] text-emerald-700">Confirmada</span>
                                <p class="mt-2 whitespace-nowrap text-[1.55rem] font-black tracking-tight text-slate-900">
                    ...
                    @else
                        <div class="mt-4 rounded-[1.35rem] border border-dashed border-slate-300 px-5 py-8 text-center text-base font-semibold text-slate-500">
                            No hay una proxima cita programada.
                        </div>
                    @endif
                </article>

                <article class="specialist-panel-card specialist-panel-summary-card rounded-[1rem] px-5 py-4">
                    <p class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">Resumen del dia</p>
                    <div class="specialist-summary-grid mt-1 grid h-[58px] -translate-y-1 items-center gap-3 lg:grid-cols-3">
                        <div class="specialist-summary-stat">
                            <div class="specialist-summary-icon bg-violet-100 text-violet-600" style="height:2.45rem;width:2.45rem;">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                            </div>
                            <div>
                                <p class="specialist-summary-value" style="font-size:1.2rem;">{{ $todaySummary['appointments'] }}</p>
                                <p class="specialist-summary-label" style="font-size:0.72rem;">Total de citas</p>
                            </div>
                        </div>

                        <div class="specialist-summary-stat">
                            <div class="specialist-summary-icon bg-sky-100 text-sky-600" style="height:2.45rem;width:2.45rem;">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <div>
                                <p class="specialist-summary-value" style="font-size:1.2rem;">{{ $todaySummary['occupiedHours'] }}</p>
                                <p class="specialist-summary-label" style="font-size:0.72rem;">Horas ocupadas</p>
                            </div>
                        </div>

                        <div class="specialist-summary-stat">
                            <div class="specialist-summary-icon bg-emerald-100 text-emerald-600" style="height:2.45rem;width:2.45rem;">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 13l4 4L19 7" />
                                </svg>
                            </div>
                            <div>
                                <p class="specialist-summary-value is-wide" style="font-size:0.82rem;">{{ $todaySummary['statusLabel'] }}</p>
                                <p class="specialist-summary-label" style="font-size:0.72rem;">{{ $todaySummary['statusHint'] }}</p>
                            </div>
                        </div>
                    </div>
                </article>
            ...
            <section class="specialist-panel-grid-two grid items-start gap-3 xl:grid-cols-2">
                        ...
                        @forelse($todayBookings as $booking)
                            <div class="specialist-panel-table-row grid grid-cols-[112px_1fr_1fr_118px] items-center gap-3 px-3 py-3">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-xs font-medium text-slate-700">{{ $booking->client->name ?? 'Cliente sin nombre' }}</span>
                                </div>
                ...
                <article class="specialist-panel-card specialist-panel-availability-card self-stretch rounded-[1rem] px-5 py-4">
                    <p class="mb-3 text-[10px] font-black uppercase tracking-[0.28em] text-slate-500">Disponibilidad semanal</p>
                    ...
                    <div class="specialist-panel-availability-list mt-2 divide-y divide-slate-100">
                        ...
                        @forelse($enabledAvailability as $slot)
                            <div class="flex w-full flex-row items-center justify-between gap-3 py-2">
                                <div class="flex w-28 shrink-0 items-center gap-2">
                                    ...
                                    <span class="text-xs font-bold text-slate-700">{{ $slot['day'] }}</span>
                                </div>

                                <span class="flex-1 text-center text-xs font-medium text-slate-500">{{ $slot['hours'] }}</span>

                                <span class="inline-flex w-24 shrink-0 items-center justify-center rounded-full bg-emerald-50 px-3 py-1 text-[9px] font-black uppercase tracking-widest text-emerald-600">
                                    Disponible
                                </span>
                            </div>
                        @empty
            ...
            <!-- Servicios Asignados -->
            <section class="specialist-panel-card specialist-panel-services-card rounded-[1rem] px-5 py-4">
                <p class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400">Servicios asignados</p>
                <div class="mt-3 grid gap-3 xl:grid-cols-2">
                    @forelse($specialist->services as $service)
                        <article class="specialist-panel-service-tile flex items-center justify-between gap-4 rounded-xl px-4 py-3 specialist-panel-service-row">
                            <div class="flex min-w-0 items-center gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="specialist-panel-service-copy mt-1 text-xs leading-snug text-slate-500">{{ $service->description ?: 'Servicio asignado al especialista.' }}</p>
                                </div>
                            </div>

                            <div class="flex shrink-0 items-center gap-2 pl-4 specialist-panel-service-meta">
                                <span class="rounded-full bg-slate-100 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-slate-600">{{ $service->durationMinutes }} min</span>
                                <span class="rounded-full bg-emerald-100 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-emerald-700">${{ number_format((float) $service->price, 0, ',', '.') }} CLP</span>
                            </div>
                        </article>
                    @empty
