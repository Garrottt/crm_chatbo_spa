    ...
    <div class="flex-1 overflow-y-auto bg-slate-100 px-6 py-6">
        <div class="mx-auto max-w-4xl space-y-6">
            <div class="rounded-[28px] bg-slate-950 px-8 py-7 text-white shadow-xl">
                ...
                <h1 class="mt-2 text-3xl font-black tracking-tight">Nueva campaña</h1>
                <p class="mt-2 text-sm text-slate-300">Define el objetivo, la oferta, el segmento y el mensaje antes de calcular la audiencia.</p>
            </div>
